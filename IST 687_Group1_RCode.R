...
H2_City <- read_excel("E:/Padhai/Sem 1/687/Final Project/H2-City.xlsx")
H1_Resort <- read_excel("E:/Padhai/Sem 1/687/Final Project/H1-Resort.xlsx")
...
plotofrepeatedGuests_City<-ggplot(data=RG_City, aes(x=CustomerType, y=ADR)) + 
  geom_bar(stat="identity", fill="steelblue") + theme_minimal() +
...
VisitorType_City<- data.frame(CityDS$Visitor_Type,CityDS$ADR)
...
VisitorType_Resort<- data.frame(ResortyDS$Visitor_Type,ResortDS$ADR)
